...
class ModelTrainer(BaseEventDrivenCMDService):
    def __init__(self,
    ...
    def process_data_event(self, event_data, json_msg):
        if not super(ModelTrainer, self).process_data_event(event_data, json_msg):
            return False
        # do something here
        pass

    def process_event_type(self, event_type, event_data, json_msg):
        if not super(ModelTrainer, self).process_event_type(event_type, event_data, json_msg):
            return False
    ...
    def log_state(self):
        super(ModelTrainer, self).log_state()

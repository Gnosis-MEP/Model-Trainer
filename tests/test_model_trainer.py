...
from model_trainer.service import ModelTrainer

from model_trainer.conf import (
    SERVICE_STREAM_KEY,
...
class TestModelTrainer(MockedEventDrivenServiceStreamTestCase):
    ...
    MOCKED_STREAMS_DICT = {
        SERVICE_STREAM_KEY: [],
        'cg-ModelTrainer': MOCKED_CG_STREAM_DICT,
    }

    @patch('model_trainer.service.ModelTrainer.process_event_type')
